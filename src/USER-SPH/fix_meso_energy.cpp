...
FixMesoEnergy::FixMesoEnergy(LAMMPS *lmp, int narg, char **arg) :
  Fix(lmp, narg, arg) {
...
void FixMesoEnergy::init() {
  dtv = update->dt;
  dtf = 0.5 * update->dt * force->ftm2v;
}

void FixMesoEnergy::setup_pre_force(int vflag)
{
  // set vest equal to v 
  double **v = atom->v;
...
void FixMesoEnergy::initial_integrate(int vflag) {
...
void FixMesoEnergy::final_integrate() {
