...
PairSPHSDPD::PairSPHSDPD(LAMMPS *lmp) : Pair(lmp)
{
  random = NULL;
  restartinfo = 0;
  first = 1;
...
void PairSPHSDPD::compute(int eflag, int vflag) {
...
double PairSPHSDPD::single(int i, int j, int itype, int jtype,
